...
Track your company's activity within the platform through **Event Logs** in your Space. All events generated by your team, from changes to rules to API activity, are recorded in one place.
...
<figure><img src="../.gitbook/assets/Screenshot 2026-07-10 at 19.17.21.png" alt="Event Logs page with the Event Logs and Service Logs tabs highlighted for navigating between event-level and API call-level records."><figcaption><p>Switch between Event Logs and Service Logs to review activity from different levels of detail.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/two more features.png" alt="Service Log detail panel showing the Correlation ID and the Inspect Event Log(s) button for opening related Event Logs."><figcaption><p>Navigate from a Service Log to its related Event Logs using the shared Correlation ID.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Screenshot 2026-07-10 at 19.51.47.png" alt="Tests view showing Rules with expandable Test Suites and individual Tests, including their input data and last run information."><figcaption><p>View and manage tests across your Space, organized by Rule and Test Suite.</p></figcaption></figure>
