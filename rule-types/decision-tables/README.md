...
<figure><img src="../../.gitbook/assets/Excel and tables.png" alt=""><figcaption></figcaption></figure>
...
{% hint style="info" %}
Once you have set up the Input-Output model, you can export your Decision Table in XLSX format. In Excel or Google Sheets, you can then add more data at once and re-import your rule into your space. For more information on creating tables using Excel or Google Sheets, click [here](https://app.gitbook.com/s/-MN4F4-qybg8XDATvios/rules/common-rule-features/rule-export-and-import/manage-tables-excel-gsheets).
{% endhint %}
...
<figure><img src="../../.gitbook/assets/Build Tables Academy 2025 (2).gif" alt=""><figcaption><p><mark style="color:purple;">Building Rows for Deciding the Luggage Price</mark></p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Strategies Academy Dec 2025.gif" alt=""><figcaption><p><mark style="color:purple;">Different solving strategies in the Test Bench of the Decision Table</mark></p></figcaption></figure>
