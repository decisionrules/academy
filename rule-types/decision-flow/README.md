---
description: >-
  This page introduces the DecisionRules Decision Flow feature, highlighting its
...
<figure><img src="../../.gitbook/assets/Even better.png" alt="" width="563"><figcaption><p>Nodes Palette in Decision Flow</p></figcaption></figure>

With the tutorial below you will be able to create a simple Decision Flow and discover node types within the rule.

{% content-ref url="create-a-decision-flow.md" %}
